	        ...
	        <div class="relative h-16 flex justify-between">
	                ...
	                <div class="w-full sm:max-w-xs">
	                    ...
	                    <div class="relative">
	                        <div class="pointer-events-none absolute inset-y-0 left-0 pl-3 flex items-center">
	                            <i class="fa fa-search h-5 w-5 text-gray-400" aria-hidden="true"></i>
	                        </div>
	            ...
	            <div class="relative z-10 flex items-center lg:hidden">
	                ...
	                <DisclosureButton class="rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:bg-gray-100 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500">
	                    ...
	                    <i v-if="!open" class="fa fa-bars block h-6 w-6" aria-hidden="true"></i>
	                    <i v-else class="fa fa-times block h-6 w-6" aria-hidden="true"></i>
	                </DisclosureButton>
	            </div>
	            <div class="hidden lg:relative lg:z-10 lg:ml-4 lg:flex lg:items-center">
	                ...
	                <Menu as="div" class="flex-shrink-0 relative ml-4">
	                    <div>
	                        <MenuButton class="bg-white rounded-full flex focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-600">
	                            <span class="sr-only">Open user menu</span>
	                            <div class="h-10 w-10 rounded-full text-white bg-green-600">
	                            	<span class="text-center">RR</span>
	                            </div>
	                        </MenuButton>
	                    </div>
